<x-admin-layout title="All Leads">
    <div class="card m-3 fade-in-up">
        <div class="card-body">
            <div class="ibox-head">
                <div class="text-right">
                    <a class="btn btn-info btn-md" href="{{ route('leads.create') }}">Add lead</a>
                </div>
            </div>
                ...
                <table class="table table-striped gy-7 gs-7">
                    ...
                    @forelse ($details as $key => $data)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('leads.edit', $data->id) }}"
                                       class="btn me-2 btn-icon btn-success">Edit</a>
                                    <form action="{{ route('leads.destroy', $data->id) }}"
                                          method="post">
                                        @csrf
                                        @method('delete')
