    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid" id="kt_login">
        ...
        <div class="d-flex flex-column flex-lg-row-auto bg-primary w-lg-600px pt-15 pt-lg-0">
            ...
            <div
                ...
                style="background-image: url(/assets/admin/media/svg/illustrations/login-1.svg)"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
...
<script src="/assets/admin/js/custom/general/login.js"></script>
<!--end::Page Custom Javascript-->
<!--end::Javascript-->
</body>
<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/start/general/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Apr 2021 10:36:15 GMT -->
</html>
